...
<meta itemprop="image" content="<?php echo $head_link .'/'. $head_imagem ?>">
...
<meta property="og:image" content="<?php echo $head_link .'/'. $head_imagem ?>">
...
<meta name="twitter:image" content="<?php echo $head_link .'/'. $head_imagem ?>">
