...
<footer class="footer">
	...
	<div class="footer-copyright">
		<div class="footer-copyright-box">
			<div class="footer-copyright-txt">© Copyrights - <?php echo date('Y') ?>. Todos os direitos reservados - Gmaes Telecom</div>
			<div class="footer-copyright-logo" style="background-image:url( img/logo-gmaes.png )"></div>
		</div>
	</div>
