...
$sql = "UPDATE audiencias_publicas SET ".
"titulo = '". $titulo ."', ".
"local = '". $local ."', ".
...
$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: audiencia_publica. Editou o item: ". $titulo ." de ID: ".$id."','". date( 'Y-m-d H:i:s' ) ."');";
