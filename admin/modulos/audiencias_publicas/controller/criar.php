...
$check_duplicate = $conn->query("SELECT id FROM audiencias_publicas WHERE titulo = '". $conn->real_escape_string($titulo) ."' LIMIT 1");
...
$sql = "INSERT INTO audiencias_publicas (
	titulo, 
	local, 
	data_publicacao, 
	data_audiencia, 
...
$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: audiencia_publica. Criou o item ". $titulo ."','". date( 'Y-m-d H:i:s' ) ."');";
