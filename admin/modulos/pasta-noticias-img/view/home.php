<div class="conteudo pasta-noticias-img">

	<div class="titulo">Pasta noticias-img</div>
	...
	<div class="linha-acao">
		...
		<form action="modulos/pasta-noticias-img/controller/enviar-arquivo.php" method="POST" enctype="multipart/form-data">
	...
	<div class="escolher-imagem-cards-box-pastas">
		...
		<?php
			...
			$directory = $raiz_site .'noticias-img/';
			...
			foreach( $files as $arquivo ){
				...
				<div class="escolher-imagem-cards-card-pastas">
					...
					<div class="escolher-imagem-cards-excluir" title="Excluir arquivo do servidor."><a href="modulos/pasta-noticias-img/view/excluir-arquivo.php?nome='. $pexcluir_arquivo_da_pasta . $arquivo .'"></a></div>
				</div>
				';
