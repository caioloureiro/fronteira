...
$galeria = $galeria_array[ count( $galeria_array ) - 1 ]['nome'];
$galeria_id = $galeria_array[ count( $galeria_array ) - 1 ]['id'];
		...
		<div class="lightbox novo-01 on">
			...
			<div class="linha linha-auto">
				<div class="comentario">
					<span>Subindo imagens para a galeria <?php echo $galeria ?>.</span>
				</div>
			</div>
			...
			<div class="linha linha-auto">
				...
				<div class="col90 exibir_capa"></div>
