...
<html lang="pt-br" prefix="og: https://ogp.me/ns#">
	...
	<body>
		...
		<div class="lightbox novo-01 on">
			...
			<div class="linha linha-auto">
				<div class="comentario">
					<span>Anexar imagens na notícia: <?php echo $noticia_titulo ?></span>
				</div>
			</div>
			...
			<div class="linha linha-auto">
				...
				<div class="exibir">
					...
					<?php
						...
						foreach( $galeria_noticias_array as $gal ){

							if( $gal['noticia_id'] == $_GET['id'] ){
								...
								<div class="thumb thumb_'. $i .'">
									<div 
										class="thumb-excluir"
										onclick="excluirArquivo( `thumb_'. $i .'`, `'. $gal['imagem'] .'` )"
									...
									<div 
										class="thumb-img"
										style="background-image:url( '. $pasta . $gal['imagem'] .' )"
									></div>
								</div>
								';
		...
		<script>
			...
			var noticia_id = <?php echo $_GET['id'] ?>;
