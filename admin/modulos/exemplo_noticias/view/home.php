...
<div class="conteudo exemplos">
	...
	<div class="linha-acao">
		...
		<a href="modulos/exemplos/view/novo-01"><button class="autores-novo-btn">Criar exemplo</button></a>
		
		<a href="modulos/exemplos/view/ordenar"><button class="noticia-nova-btn">Ordenar Destaques</button></a>
		...
		<table class="tabela_exemplos">
			...
			<tbody>
				...
				<?php
					...
					usort( $exemplos_array, function( $a, $b ){//Função responsável por ordenar
					...
					foreach( $exemplos_array as $item ){
						...
						if( $item['destaque'] == 1 ){
							...
							<tr>
								...
								<td>
									<form method="GET" action="modulos/exemplos/controller/destaque">
