...
if( $_POST['editor_texto'] == '' ){
	echo'<script>alert("Preencha o conteúdo."); window.history.back();</script>'; exit;
}
...
$sql = "UPDATE popup_paginas SET ".
"tipo = '". $tipo ."', ".
"conteudo = '". $conteudo ."' ".
"WHERE id = ". $id .";";

$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: popup_paginas. Editou o item de ID: ".$id."','". date( 'Y-m-d H:i:s' ) ."');";
