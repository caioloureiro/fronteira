...
$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Mudou o status de ativação do popup página ID: ". $_GET['id'] ."','". date( 'Y-m-d H:i:s' ) ."');";
