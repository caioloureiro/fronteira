<div class="conteudo pasta-img">

	<div class="titulo">Pasta img</div>
	...
	<div class="linha-acao">
		...
		<form action="modulos/pasta-img/controller/enviar-arquivo.php" method="POST" enctype="multipart/form-data">
		...
		<?php
			...
			foreach( $files as $arquivo ){
				...
				<div class="escolher-imagem-cards-card-pastas">
					...
					<div class="escolher-imagem-cards-excluir" title="Excluir arquivo do servidor."><a href="modulos/pasta-img/view/excluir-arquivo.php?nome='. $pexcluir_arquivo_da_pasta . $arquivo .'"></a></div>
				</div>
				';
