...
$sql = "INSERT INTO menu_admin_start ( 
	menu_admin_id, 
	permissao
) VALUES ( ".
	"". $menu_admin_id .", ".
...
$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: menu_admin_start e menu_admin_sinc. Criou o item ". $nome ."','". date( 'Y-m-d H:i:s' ) ."');";
