...
if(!isset($_POST['arquivo_servidor']) || !isset($_POST['legislacao'])) {
...
$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Anexou arquivo do servidor para legislação: ".$arquivo_servidor."','". date( 'Y-m-d H:i:s' ) ."');";
