...
$sql = "UPDATE acesso_facil_base SET ".
"nome = '". $nome ."' ".
"WHERE id = ". $id .";";

$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: acesso_facil_base. Editou o item: ". $nome ." de ID: ".$id."','". date( 'Y-m-d H:i:s' ) ."');";
		...
		<div class="box">
			...
			<?php
				...
				if ($conn->multi_query( $sql ) === TRUE) {
					...
					<a href="'. $raiz_admin .'matriz?pagina=acesso_facil_base" ><div class="linha"><button>Retornar</button></div></a>
					';
