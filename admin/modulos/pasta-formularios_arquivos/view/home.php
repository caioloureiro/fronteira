<div class="conteudo pasta-formularios_arquivos">

	<div class="titulo">Pasta formularios_arquivos</div>
	...
	<div class="linha-acao">
		...
		<form action="modulos/pasta-formularios_arquivos/controller/enviar-arquivo.php" method="POST" enctype="multipart/form-data">
	...
	<div class="escolher-imagem-cards-box-pastas">
		...
		<?php
			...
			$directory = $raiz_site .'formularios_arquivos/';
			...
			foreach( $files as $arquivo ){
				...
				<div class="escolher-imagem-cards-card-pastas">
					...
					<div class="escolher-imagem-cards-excluir" title="Excluir arquivo do servidor."><a href="modulos/pasta-formularios_arquivos/view/excluir-arquivo.php?nome='. $pexcluir_arquivo_da_pasta . $arquivo .'"></a></div>
				</div>
				';
...
let arquivos = document.querySelector('.escolher-imagem-cards-box-pastas');
let arquivos_busca = document.querySelector('.escolher-imagem-cards-input');

if( arquivos ){
	
	arquivos_busca.addEventListener('keyup', function() {

		arquivos_busca = document.querySelector('.escolher-imagem-cards-input').value.toUpperCase();
		
		let card = arquivos.querySelectorAll('.escolher-imagem-cards-card-pastas');
		
		for( let i = 0; i < card.length; i++ ){

			let a = card[i].querySelector('.escolher-imagem-cards-titulo');
			
			if( a.innerHTML.toUpperCase().indexOf( arquivos_busca ) > -1 ){
