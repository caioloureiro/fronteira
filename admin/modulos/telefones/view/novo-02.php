...
<html lang="pt-br" prefix="og: https://ogp.me/ns#">
	...
	<body>
		...
		<div class="lightbox telefones-nova on">
			...
			<form action="../controller/criar.php" method="POST">
				...
				<div class="linha"><div class="col10"><span>Nome: </span></div><div class="col90"><input name="nome" required /></div></div>
				<div class="linha"><div class="col10"><span>Telefone: </span></div><div class="col90"><input name="fone" required /></div></div>
				<div class="linha"><div class="col10"><span>Link: </span></div><div class="col90"><input name="pagina_contato" value="#" /></div></div>
				<div class="linha"><div class="col10"><span>Descrição: </span></div><div class="col90"><input name="descricao" /></div></div>
