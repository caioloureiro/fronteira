	...
	<body>
		...
		<div class="lightbox anexo-nova on">
			...
			<form action="../controller/criar.php" method="POST">
				...
				<div class="linha">
					...
					<div class="col90">
						<span>
							<select class="concurso" name="concurso">
								<option value="0">Selecione o concurso</option>
								
								<?php
									
									foreach( $concursos_array as $conc ){
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=concursos_anexos';
