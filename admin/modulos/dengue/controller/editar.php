...
$sql = "UPDATE dengue SET ".
"data = '". $data ."', ".
"confirmados = '". $confirmados ."', ".
"casos_autoctones = '". $casos_autoctones ."', ".
"casos_importados = '". $casos_importados ."', ".
"descartados = '". $descartados ."', ".
"aguardando = '". $aguardando ."', ".
"notificacoes = '". $notificacoes ."', ".
"casos_regiao_norte = '". $casos_regiao_norte ."', ".
"casos_regiao_sul = '". $casos_regiao_sul ."', ".
"casos_regiao_central = '". $casos_regiao_central ."', ".
"casos_regiao_leste = '". $casos_regiao_leste ."', ".
"casos_regiao_oeste = '". $casos_regiao_oeste ."' ".
"WHERE id = ". $id .";";

$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: dengue. Editou o item: ". $data ." de ID: ".$id."','". date( 'Y-m-d H:i:s' ) ."');";
