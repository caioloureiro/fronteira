...
//$sql = "DELETE FROM licitacoes_categorias WHERE id = ". $id .";";
$sql = "UPDATE licitacoes_categorias SET ativo = 0 WHERE id = ". $id .";";

$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: licitacoes_categorias. Excluiu o item de ID: ".$id."','". date( 'Y-m-d H:i:s' ) ."');";
