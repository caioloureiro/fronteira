<div class="conteudo pasta-acesso-rapido">

	<div class="titulo">Pasta acesso-rapido</div>
	...
	<div class="linha-acao">
		...
		<form action="modulos/pasta-acesso-rapido/controller/enviar-arquivo.php" method="POST" enctype="multipart/form-data">
	...
	<div class="escolher-imagem-cards-box-pastas">
		...
		<?php
			...
			$directory = $raiz_site .'acesso-rapido/';
			...
			foreach( $files as $arquivo ){
				...
				<div class="escolher-imagem-cards-card-pastas">
					...
					<div class="escolher-imagem-cards-excluir" title="Excluir arquivo do servidor."><a href="modulos/pasta-acesso-rapido/view/excluir-arquivo.php?nome='. $pexcluir_arquivo_da_pasta . $arquivo .'"></a></div>
				</div>
				';
