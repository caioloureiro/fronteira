...
<html lang="pt-br" prefix="og: https://ogp.me/ns#">
	<head>
		...
		<title>Editar concursos_categorias</title>
	...
	<body>
		...
		<?php 
			...
			foreach( $concursos_categorias_array as $item ){
				...
				if( $item['id'] == $_GET['id'] ){
					...
					echo'
					<div class="lightbox concursos_categorias-editar on">
						...
						<form action="../controller/editar.php" method="POST">
							...
							<div class="lightbox-titulo">
								...
								Editar concursos_categorias: '. $item['nome'] .'
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=concursos_categorias';
