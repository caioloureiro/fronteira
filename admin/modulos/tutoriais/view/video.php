...
foreach( $tutoriais_array as $video ){
	...
	if( $video['get'] == $_GET['nome'] ){
		
		$youtube_titulo = $video['nome']; 
...
<html lang="pt-br" prefix="og: https://ogp.me/ns#">
	...
	<body>
		...
		<div class="lightbox tutoriais-nova on">
			
			<div class="lightbox-titulo">

				Tutoriais: <?php echo $youtube_titulo ?>
				<div 
			...
			<div class="linha linha-auto">
				...
				<div class="video">
					<iframe 
						src="https://www.youtube.com/embed/<?php echo $youtube_video ?>" 
						frameborder="0" 
						allow="
							accelerometer; 
							autoplay; 
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=tutoriais';
