...
if( $_GET['tema'] == 'claro' ){ $tema = 'escuro'; }
if( $_GET['tema'] == 'escuro' ){ $tema = 'claro'; }

$sql = "UPDATE admin_user SET ".
"tema = '". $tema ."' ".
"WHERE id = ". $_GET['user_id'] .";";

$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Mudou o tema para ". $tema ."','". date( 'Y-m-d H:i:s' ) ."');";
