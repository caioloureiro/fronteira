...
$sql = "UPDATE parcerias_anexos SET ".
"nome = '". $nome ."', ".
"arquivo = '". $arquivo ."', ".
"parceria = '". $parceria ."' ".
"WHERE id = ". $id .";";

$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: parcerias_anexos. Editou o item: ". $nome ." de ID: ".$id."','". date( 'Y-m-d H:i:s' ) ."');";
