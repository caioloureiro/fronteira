...
if( 
	...
	echo'
	<script>
		alert("Já existem 4 destaques. Por favor retire um.");
		window.history.back();
	</script>
	';
	exit;
...
$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Modificou o destaque de videos ID: ".$_GET['id']."','". date( 'Y-m-d H:i:s' ) ."');";
