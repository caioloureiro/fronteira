...
$check_duplicate = $conn->query("SELECT id FROM chamadas_publicas WHERE titulo = '". $conn->real_escape_string($titulo) ."' LIMIT 1");
...
$sql = "INSERT INTO chamadas_publicas (
	titulo, 
	categorias, 
	arquivo, 
	data 
...
$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: chamadas_publicas. Criou o item ". $titulo ."','". date( 'Y-m-d H:i:s' ) ."');";
