	...
	<body>
		...
		<div class="lightbox novo-01 on">
			...
			<div class="lightbox-titulo">
				...
				Deseja enviar a arquivo para o servidor?
			...
			<div class="linha-acao">
				...
				<form action="../controller/enviar-arquivo.php" method="POST" enctype="multipart/form-data">
					...
					<label class="btn arquivo_escolhido" for="arquivo" title="Clique aqui para selecionar o arquivo desejado.">Escolher arquivo do computador</label>

					<input type="file" name="arquivo_subir" id="arquivo" />

					<button type="submit" class="enviar-arquivo-submit" title="Clique aqui para ENVIAR.">Enviar arquivo</button>
