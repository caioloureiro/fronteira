	...
	<body>
		...
		<?php 
			...
			foreach( $chamadas_publicas_array as $item ){
				...
				if( $item['id'] == $_GET['id'] ){
					...
					echo'
					<div class="lightbox chamadas_publicas-editar on">
						...
						<form action="../controller/editar.php" method="POST">
							...
							<div class="lightbox-titulo">
								...
								Editar chamada pública: '. $item['titulo'] .'
								<div 
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=chamadas_publicas';
