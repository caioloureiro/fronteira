	...
	<body>
		...
		<?php 
			...
			foreach( $noticias_categorias_array as $item ){
				...
				if( $item['id'] == $_GET['id'] ){
					...
					echo'
					<div class="lightbox noticias_categorias-editar on">
						...
						<form action="../controller/editar.php" method="POST">
							...
							<div class="lightbox-titulo">
								...
								Editar noticias_categorias: '. $item['nome'] .'
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=noticias_categorias';
