...
$check_duplicate = $conn->query("SELECT id FROM noticias_categorias WHERE nome = '". $conn->real_escape_string($nome) ."' LIMIT 1");
...
$sql = "INSERT INTO noticias_categorias (
	nome
) VALUES (".
	"'". $nome ."'".
");";

$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: noticias_categorias. Criou o item ". $nome ."','". date( 'Y-m-d H:i:s' ) ."');";
