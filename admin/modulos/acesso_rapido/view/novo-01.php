	...
	<body>
		...
		<div class="lightbox novo-01 on">
			...
			<div class="linha-acao">
				...
				<div class="comentario">Formato PNG, tamanho 512x512px.</div>
				
				<form action="../controller/enviar-arquivo.php" method="POST" enctype="multipart/form-data">

					<label class="btn arquivo_escolhido" for="arquivo" title="Clique aqui para selecionar o arquivo desejado.">Escolher ícone do computador.</label>
