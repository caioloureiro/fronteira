...
$sql = "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Subiu o arquivo ( upload - parcerias ): ".$pasta.$nome_final."','". date( 'Y-m-d H:i:s' ) ."');";
