...
<html lang="pt-br" prefix="og: https://ogp.me/ns#">
	<head>
		...
		<title>Editar legislacoes_categorias</title>
	...
	<body>
		...
		<?php 
			...
			foreach( $legislacoes_categorias_array as $item ){
				...
				if( $item['id'] == $_GET['id'] ){
					...
					echo'
					<div class="lightbox legislacoes_categorias-editar on">
						...
						<form action="../controller/editar.php" method="POST">
							...
							<div class="lightbox-titulo">
								...
								Editar legislacoes_categorias: '. $item['nome'] .'
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=legislacoes_categorias';
