...
<html lang="pt-br" prefix="og: https://ogp.me/ns#">
	<head>
		...
		<title>Editar perguntas_frequentes</title>
		...
		<?php 
			...
			foreach( $perguntas_frequentes_array as $item ){
				...
				if( $item['id'] == $_GET['id'] ){
					...
					$editor_de_texto_json = json_encode( $item['resposta'], JSON_PRETTY_PRINT ); //Criei um JSON
					//dd( $editor_de_texto_json );
					/*End - RECEBE OD DADOS PHP DO BANCO E COLOCA NO PLUGIN EDITOR DE TEXTOS*/
				
					echo'
					<div class="lightbox perguntas_frequentes-editar on">
