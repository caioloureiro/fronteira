...
$check_duplicate = $conn->query("SELECT id FROM transparencia WHERE nome = '". $conn->real_escape_string($nome) ."' LIMIT 1");
...
$sql = "INSERT INTO transparencia (
	nome
) VALUES (".
	"'". $nome ."'".
");";

$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['saojosedonorte_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: transparencia. Criou o item ". $nome ."','". date( 'Y-m-d H:i:s' ) ."');";
