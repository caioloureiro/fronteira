		...
		<?php 
			...
			foreach( $cemiterios_array as $item ){
				...
				if( $item['id'] == $_GET['id'] ){
					...
					echo'
					<div class="lightbox cemiterios-editar on">
							...
							<div class="linha">
								...
								<div class="col90">
									...
									>
										<option 
											value="S"
											'; if( $item['cemAtivo'] == 'S' ){ echo 'selected'; } echo'
										>Sim</option>
										<option 
											value="N"
											'; if( $item['cemAtivo'] == 'N' ){ echo 'selected'; } echo'
										>Não</option>
									</select>
								</div>
							</div>
