...
require $raiz_site .'model/cemiterios.php';
...
$sql = "UPDATE cemiterios SET ".
"cemCodigo = ". $cemCodigo .", ".
"cemNome = '". $cemNome ."', ".
"cemTelefone = '". $cemTelefone ."', ".
"cemEndereco = '". $cemEndereco ."', ".
"cemEmail = '". $cemEmail ."', ".
"cemDescricao = '". $cemDescricao ."', ".
"cemAtivo = '". $cemAtivo ."' ".
"WHERE id = ". $id .";";

$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: cemiterios. Editou o item: ". $cemNome ." de ID: ".$id."','". date( 'Y-m-d H:i:s' ) ."');";
