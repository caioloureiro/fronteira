...
<div class="conteudo pasta-uploads">

	<div class="titulo">Pasta Uploads</div>
	...
	<div class="linha-acao">
		...
		<form action="modulos/pasta-uploads/controller/enviar-arquivo.php" method="POST" enctype="multipart/form-data">
	...
	<table class="tabela_pasta-uploads">
					...
					if( is_file($directory.$arquivo) ){ //SOMENTE ARQUIVOS
						...
						<tr>
							...
							<td>
								...
								<a href="modulos/pasta-uploads/view/excluir-arquivo.php?nome='. $arquivo .'"><div class="tabela-btn tabela-btn-excluir" title="Excluir"></div></a>
	...
	<div id="paginacao_pasta-uploads" class="pagination"></div>

</div>

<script>
let tabela_hotel_atalaia_img = document.querySelector('.tabela_pasta-uploads');
var datatable = new DataTable( tabela_hotel_atalaia_img, {
	sort: [false, true],
	filters: [false, true],
	filterText: 'Buscar... ',
	pagingDivSelector: "#paginacao_pasta-uploads"
});
</script>