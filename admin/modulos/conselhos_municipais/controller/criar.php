...
$check_duplicate = $conn->query("SELECT id FROM conselhos_municipais WHERE nome = '". $conn->real_escape_string($nome) ."' LIMIT 1");
...
$sql = "INSERT INTO conselhos_municipais (
	nome, 
	pagina
) VALUES (".
	"'". $nome ."', ".
...
$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Tabela: conselhos_municipais. Criou o item ". $nome ."','". date( 'Y-m-d H:i:s' ) ."');";
