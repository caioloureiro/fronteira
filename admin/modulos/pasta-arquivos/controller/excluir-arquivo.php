	...
	<body>
		...
		<div class="box">
			...
			<?php
				...
				echo'
				<div class="alerta-verde">Arquivo EXCLUÍDO com sucesso!</div>
				<div class="submenu-novo-btn"><a href="'. $raiz_admin .'matriz?pagina=pasta-arquivos" >Retornar</a></div>
				';
