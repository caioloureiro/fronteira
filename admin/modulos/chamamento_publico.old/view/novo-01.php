	...
	<body>
		...
		<div class="lightbox novo-01 on">
			...
			<div class="lightbox-titulo">
				...
				Deseja enviar arquivos para o servidor?
			...
			<div class="linha linha-auto">
				<div class="comentario">
					<span>Pode subir vários arquivos aqui. Estes arquivos serão cadastrados na página de downloads e serão vinculados como editais no Chamamento Público criado.</span>
				</div>
			</div>
			...
			<div class="linha-acao">
				...
				<form action="../controller/enviar-arquivo.php" method="POST" enctype="multipart/form-data">
					...
					<input type="file" name="arquivos_subir[]" id="arquivo" multiple />
