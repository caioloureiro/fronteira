<div class="conteudo pasta-secretarias">

	<div class="titulo">Pasta secretarias</div>
	...
	<div class="linha-acao">
		...
		<form action="modulos/pasta-secretarias/controller/enviar-arquivo.php" method="POST" enctype="multipart/form-data">
	...
	<div class="escolher-imagem-cards-box-pastas">
		...
		<?php
			...
			$directory = $raiz_site .'secretarias/';
			...
			foreach( $files as $arquivo ){
				...
				<div class="escolher-imagem-cards-card-pastas">
					...
					<div class="escolher-imagem-cards-excluir" title="Excluir arquivo do servidor."><a href="modulos/pasta-secretarias/view/excluir-arquivo.php?nome='. $pexcluir_arquivo_da_pasta . $arquivo .'"></a></div>
				</div>
				';
