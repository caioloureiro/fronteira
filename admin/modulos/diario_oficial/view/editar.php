...
<html lang="pt-br" prefix="og: https://ogp.me/ns#">
	<head>
		...
		<title>Editar diario_oficial</title>
	</head>
	<body>
		...
		<?php 
			...
			foreach( $diario_oficial_array as $item ){
				...
				if( $item['id'] == $_GET['id'] ){
					...
					echo'
					<div class="lightbox diario_oficial-editar on">
						...
						<form action="../controller/editar.php" method="POST">
							...
							<div class="lightbox-titulo">
								...
								Editar diario oficial: '. $item['titulo'] .'
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=diario_oficial';
