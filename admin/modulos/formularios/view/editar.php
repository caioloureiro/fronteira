		...
		<?php 
			...
			foreach( $formularios_array as $item ){
				...
				if( $item['id'] == $_GET['id'] ){
					...
					echo'
					<div class="lightbox formulario-editar on">
						...
						<form action="../controller/editar.php" method="POST">
										...
										>
											';
												...
												foreach( $paginas as $pag ){
													...
													echo '
													<option 
														'; if( $item['pagina'] == $pag['pagina'] ){ echo 'selected'; } echo'
														value="'. $pag['pagina'] .'"
													>'. $pag['titulo'] .'</option>
													';
							...
							<div class="linha-acao">
								...
								<div class="col15">
									<span>
										<div class="btn vermelho" onclick="apagar()">Apagar Formulário</div>
									</span>
								</div>
								<div class="col15">
									<span>
					...
					$recebe_formulario_input .= $item['formulario'];
		...
		<script>
			...
			function editarQuestaoSet( counterQuestao, tipo ){
				...
				for( var i in alvo_array ) {
					...
					if( alvo_array[i] ){
						...
						//console.log( 'alvo_i_array[1]', alvo_i_array[1] );
						...
						if( alvo_i_tipo == 'opcoes' ){ novoOpcoes = alvo_i_array[1]; }
			...
			function adicionarQuestao(){
				...
				if( questaoTipoCampo == 'select' ){
					...
					formulario_campo.innerHTML += ''+
					'<div class="linha questao_'+ counterQuestao +'" style="height:10vw;">'+
						'<div class="col10"><span>'+ questaoNomeCampo +'</span></div>'+
			...
			let recebe_formulario_input = "<?php echo $recebe_formulario_input ?>";
			let formulario_campo = document.querySelector('.formulario_campo');
			let formulario_input = document.querySelector('.formulario_input');
			
			//console.log( 'recebe_formulario_input', recebe_formulario_input ); 
			
			const recebe_formulario_input_array = recebe_formulario_input.split(";");
			
			//console.log( 'recebe_formulario_input_array', recebe_formulario_input_array ); 
			
			for( var item in recebe_formulario_input_array ) {
	
				//console.log( 'recebe_formulario_input_array[item]', recebe_formulario_input_array[item] );
				
				const quest_array = recebe_formulario_input_array[item].split("=");
			...
			function getCampo( recebe_formulario_input, questao, campo ){
			...
			for( let i = 1; i <= counterQuestao; i++ ){ //MONTA O FORMULÁRIO QUE VEM DO BANCO
				...
				if( getCampo( recebe_formulario_input, i, 'obrigatorio' ) ){
				...
				if( 
					getCampo( recebe_formulario_input, i, 'tipo' ) 
					&& ( 
						getCampo( recebe_formulario_input, i, 'tipo' ) == 'titulo'
						|| getCampo( recebe_formulario_input, i, 'tipo' ) == 'subtitulo'
					)
				){
					
					formulario_campo.innerHTML += ''+
					'<div class="linha linha-auto questao_'+ i +'">'+
						'<div class="col10"><span class="questao_campo">'+ i +': '+ getCampo( recebe_formulario_input, i, 'campo' ) +'</span></div>'+
						'<div class="col10"><span class="questao_tipo">'+ getCampo( recebe_formulario_input, i, 'tipo' ) +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
								'<div '+
									'class="btn icone" '+
				...
				if( 
					getCampo( recebe_formulario_input, i, 'tipo' ) 
					&& (
						getCampo( recebe_formulario_input, i, 'tipo' ) == 'text'
						|| getCampo( recebe_formulario_input, i, 'tipo' ) == 'email'
						|| getCampo( recebe_formulario_input, i, 'tipo' ) == 'date'
						|| getCampo( recebe_formulario_input, i, 'tipo' ) == 'time'
						|| getCampo( recebe_formulario_input, i, 'tipo' ) == 'datetime-local'
						|| getCampo( recebe_formulario_input, i, 'tipo' ) == 'file'
					)
				){
					...
					'<div class="linha linha-auto questao_'+ i +'">'+
						'<div class="col10"><span class="questao_campo">'+ i +': '+ getCampo( recebe_formulario_input, i, 'campo' ) +'</span></div>'+
						'<div class="col10"><span class="questao_tipo"><input type="'+ getCampo( recebe_formulario_input, i, 'tipo' ) +'" disabled/></span></div>'+
						'<div class="col20"><span class="questao_comentario">'+ getCampo( recebe_formulario_input, i, 'comentario' ) +'</span></div>'+
						'<div class="col05"><span class="questao_obrigatorio">'+ obrigatorio +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
								'<div '+
				...
				if( 
					getCampo( recebe_formulario_input, i, 'tipo' ) 
					&& getCampo( recebe_formulario_input, i, 'tipo' ) == 'textarea'
				){
				...
				if( 
					getCampo( recebe_formulario_input, i, 'tipo' ) 
					&& getCampo( recebe_formulario_input, i, 'tipo' ) == 'radio_s_n'
				){
					
					formulario_campo.innerHTML += ''+
					'<div class="linha linha-auto questao_'+ i +'">'+
						'<div class="col10"><span class="campo">'+ i +': '+ getCampo( recebe_formulario_input, i, 'campo' ) +'</span></div>'+
						...
						'<div class="col20"><span>'+ getCampo( recebe_formulario_input, i, 'comentario' ) +'</span></div>'+
						'<div class="col05"><span>'+ obrigatorio +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
								'<div '+
				...
				if( 
					getCampo( recebe_formulario_input, i, 'tipo' ) 
					&& getCampo( recebe_formulario_input, i, 'tipo' ) == 'radio'
				){
					...
					'<div class="linha linha-auto questao_'+ i +'">'+
						...
						'<div class="col10"><span class="questao_comentario">'+ getCampo( recebe_formulario_input, i, 'comentario' ) +'</span></div>'+
						'<div class="col05"><span class="questao_obrigatorio">'+ obrigatorio +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
								'<div '+
				...
				if( 
					getCampo( recebe_formulario_input, i, 'tipo' ) 
					&& getCampo( recebe_formulario_input, i, 'tipo' ) == 'checkbox'
				){
				...
				if( 
					getCampo( recebe_formulario_input, i, 'tipo' )
					&& getCampo( recebe_formulario_input, i, 'tipo' ) == 'select'
				){
					
					let opcoes = getCampo( recebe_formulario_input, i, 'opcoes' );
					//console.log( 'opcoes', opcoes );
					...
					'<div class="linha linha-auto questao_'+ i +'">'+
						...
						'<div class="col10">'+
							'<span>'+
								'<select class="contato-form-input questao_'+ i +' select">'+ opcoes_html +'</select>'+
							'</span>'+
						'</div>'+
						'<div class="col15"><span class="questao_comentario">'+ getCampo( recebe_formulario_input, i, 'comentario' ) +'</span></div>'+
						'<div class="col05"><span class="questao_obrigatorio">'+ obrigatorio +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
								'<div '+
				...
				if( 
					getCampo( recebe_formulario_input, i, 'opcao01' ) 
					&& getCampo( recebe_formulario_input, i, 'opcao01' ) != ''
				){

					if( getCampo( recebe_formulario_input, i, 'tipo' ) == 'radio' ){
						...
						'<div class="col05">'+
							...
							'</span>'+
						'</div>'+
						'<div class="col10"><span class="questao_'+ i +'_opcao01">'+ getCampo( recebe_formulario_input, i, 'opcao01' ) +'</span></div>'+
						'';
						
					}
					
					if( getCampo( recebe_formulario_input, i, 'tipo' ) == 'checkbox' ){
				...
				if( 
					getCampo( recebe_formulario_input, i, 'opcao02' ) 
					&& getCampo( recebe_formulario_input, i, 'opcao02' ) != ''
				){
					...
					if( getCampo( recebe_formulario_input, i, 'tipo' ) == 'radio' ){
						...
						'<div class="col05">'+
							...
							'</span>'+
						'</div>'+
						'<div class="col10"><span class="questao_'+ i +'_opcao02">'+ getCampo( recebe_formulario_input, i, 'opcao02' ) +'</span></div>'+
						'';
				...
				if( 
					getCampo( recebe_formulario_input, i, 'opcao03' ) 
					&& getCampo( recebe_formulario_input, i, 'opcao03' ) != ''
				){
					...
					if( getCampo( recebe_formulario_input, i, 'tipo' ) == 'radio' ){
						...
						'<div class="col05">'+
							...
							'</span>'+
						'</div>'+
						'<div class="col10"><span class="questao_'+ i +'_opcao03">'+ getCampo( recebe_formulario_input, i, 'opcao03' ) +'</span></div>'+
						'';
				...
				if( 
					getCampo( recebe_formulario_input, i, 'opcao04' ) 
					&& getCampo( recebe_formulario_input, i, 'opcao04' ) != ''
				){
					...
					if( getCampo( recebe_formulario_input, i, 'tipo' ) == 'radio' ){
						...
						'<div class="col05">'+
							...
							'</span>'+
						'</div>'+
						'<div class="col10"><span class="questao_'+ i +'_opcao04">'+ getCampo( recebe_formulario_input, i, 'opcao04' ) +'</span></div>'+
						'';
				...
				if( 
					getCampo( recebe_formulario_input, i, 'opcao05' ) 
					&& getCampo( recebe_formulario_input, i, 'opcao05' ) != ''
				){
					...
					if( getCampo( recebe_formulario_input, i, 'tipo' ) == 'radio' ){
						...
						'<div class="col05">'+
							...
							'</span>'+
						'</div>'+
						'<div class="col10"><span class="questao_'+ i +'_opcao05">'+ getCampo( recebe_formulario_input, i, 'opcao05' ) +'</span></div>'+
						'';
