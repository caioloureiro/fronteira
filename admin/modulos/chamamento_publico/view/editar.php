...
<html lang="pt-br" prefix="og: https://ogp.me/ns#">
	<head>
		...
		<title>Editar chamamento_publico</title>
									...
									';
										...
										foreach( $editais_array as $edital ){
											...
											if( $edital['modalidade_item_id'] == $_GET['id'] ){
												...
												echo'
												<div class="tagBtn tagBtn_'. $edital['id'] .'">
													<div class="tagBtn-nome">'. $edital['arquivo'] .'</div>
													<div 
														class="tagBtn-excluir"
														title="Desvincular este arquivo."
														onclick="excluirArquivo( `tagBtn_'. $edital['id'] .'`, `'. $edital['arquivo'] .'` )"
		...
		<script>
			...
			if( document.querySelector('#arquivo') ){
				...
				arquivo.addEventListener('change', function() {
					...
					//incluirEdital( chamamento_publico_id, this.files ); //ERRO
					alert( 'Por favor, selecione o arquivo no botão "Escolher arquivos do servidor."' );
