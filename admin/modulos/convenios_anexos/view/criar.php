	...
	<body>
		...
		<div class="lightbox anexo-nova on">
			...
			<form action="../controller/criar.php" method="POST">
				...
				<div class="linha">
					...
					<div class="col90">
						<span>
							<select class="convenio" name="convenio">
								<option value="0">Selecione o convenio</option>
								
								<?php
									
									foreach( $convenios_array as $conc ){
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=convenios_anexos';
