...
<html lang="pt-br" prefix="og: https://ogp.me/ns#">
	<head>
		...
		<title>Editar licitacoes_situacao</title>
	...
	<body>
		...
		<?php 
			...
			foreach( $licitacoes_situacao_array as $item ){
				...
				if( $item['id'] == $_GET['id'] ){
					...
					echo'
					<div class="lightbox licitacoes_situacao-editar on">
						...
						<form action="../controller/editar.php" method="POST">
							...
							<div class="lightbox-titulo">
								...
								Editar licitacoes_situacao: '. $item['nome'] .'
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=licitacoes_situacao';
