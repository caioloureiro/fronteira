...
$sql .= "INSERT INTO rastrear_usuario (usuario, descricao, horario) VALUES ('". $_COOKIE['fronteira_ADMIN_SESSION_usuario'] ." - ". $_SERVER['REMOTE_ADDR'] ."','Modificou o destaque do edital ID: ".$_GET['id']."','". date( 'Y-m-d H:i:s' ) ."');";
