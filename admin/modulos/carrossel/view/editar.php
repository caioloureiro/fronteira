	...
	<body>
							...
							<div class="col05">
								<span>
									<input 
										...
										value="0"
										type="radio"
										'; if( $item['mobile'] == 0 ){ echo'checked'; } echo' 
									/>
								</span>
							</div>
							<div class="col05">
							...
							<div class="col05">
								<span>
									<input 
										...
										value="1"
										type="radio"
										'; if( $item['mobile'] == 1 ){ echo'checked'; } echo' 
									/>
								</span>
							</div>
							<div class="col05">
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=carrossel';
			...
			function gravar(){
				...
				xhr.open( 'POST', '../controller/editar.php', true );
