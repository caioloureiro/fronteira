	...
	<body>
		...
		<?php 
			...
			foreach( $enquete_array as $item ){
				...
				if( $item['id'] == $_GET['id'] ){
					...
					echo'
					<div class="lightbox enquete-editar on">
						...
						<form action="../controller/editar.php" method="POST">
							...
							<div class="linha-acao">
								...
								<div class="col15">
									<span>
										<div class="btn vermelho" onclick="apagar()">Apagar Enquete</div>
									</span>
								</div>
								<div class="col15">
									<span>
										<div class="btn" onclick="window.location.reload(true);">Reiniciar Edições</div>
									</span>
								</div>
					...
					$recebe_enquete_input .= $item['formulario'];
		...
		<script>
			...
			function voltar(){
				...
				window.location.href = '<?php echo $raiz_admin ?>matriz?pagina=enquetes';
			...
			function apagar(){
				...
				let enquete_campo = document.querySelector('.enquete_campo');
				let enquete_input = document.querySelector('.enquete_input');
				
				enquete_campo.innerHTML = '';
				enquete_input.value = '';
			...
			function apagarQuestao( counterQuestao ){
				...
				let enquete_campo = document.querySelector('.enquete_campo');
				let enquete_input = document.querySelector('.enquete_input').value;
				
				//console.log( 'enquete_input', enquete_input ); 
				
				const enquete_input_array01 = enquete_input.split("questao_"+ counterQuestao +"_start;");
				//console.log( 'enquete_input_array01[0]', enquete_input_array01[0] ); 
				
				const enquete_input_array02 = enquete_input.split("questao_"+ counterQuestao +"_end;");
				//console.log( 'enquete_input_array02[1]', enquete_input_array02[1] ); 
				
				document.querySelector('.enquete_input').value = '';
				document.querySelector('.enquete_input').value = enquete_input_array01[0] + enquete_input_array02[1];
				//console.log( 'document.querySelector(.enquete_input).value', document.querySelector('.enquete_input').value ); 
			...
			function editarQuestaoSet( counterQuestao, tipo ){
				...
				const enquete_input_alvo_array01 = enquete_input_array01[1];
				//console.log( 'enquete_input_alvo_array01', enquete_input_alvo_array01 );
				
				const enquete_input_alvo_array02 = enquete_input_alvo_array01.split("questao_"+ counterQuestao +"_end;");
				//console.log( 'enquete_input_alvo_array02', enquete_input_alvo_array02 );
				
				const enquete_input_alvo = enquete_input_alvo_array02[0];
				//console.log( 'enquete_input_alvo', enquete_input_alvo );
				
				const alvo_array = enquete_input_alvo.split(";");
				...
				let resultado = enquete_input_array01[0] + novoItemTexto + enquete_input_array02[1];
				//console.log( 'resultado: ', resultado );
				
				document.querySelector('.enquete_input').value = resultado;
			...
			function editarQuestao( counterQuestao ){
				...
				const enquete_input_array01 = enquete_input.split("questao_"+ counterQuestao +"_start;");
				//console.log( 'enquete_input_array01[1]', enquete_input_array01[1] ); 
				
				const enquete_input_array02 = enquete_input_array01[1].split("questao_"+ counterQuestao +"_end;");
				//console.log( 'enquete_input_array02[0]', enquete_input_array02[0] ); 
				
				document.querySelector('.dialogo-top').innerHTML = 'Questão '+ counterQuestao;
				
				const questao_array = enquete_input_array02[0].split(";");
			...
			function adicionarQuestao(){
				...
				if(
					...
					enquete_campo.innerHTML += ''+
					'<div class="linha questao_'+ counterQuestao +'">'+
						'<div class="col10"><span class="questao_campo">'+ questaoNomeCampo +'</span></div>'+
				...
				if( questaoTipoCampo == 'file' ){
					...
					'<div class="linha questao_'+ counterQuestao +'">'+
						...
						'<div class="col20"><span>'+ questaoComentario +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
								'<div '+
									'class="btn icone" '+
				...
				if( 
					...
					|| questaoTipoCampo == 'select' 
				){
				
					enquete_campo.innerHTML += ''+
					'<div class="linha questao_'+ counterQuestao +'">'+
						'<div class="col10"><span>'+ questaoNomeCampo +'</span></div>'+
						'<div class="col05"><span>Opções: </span></div>'+
			...
			let recebe_enquete_input = "<?php echo $recebe_enquete_input ?>";
			let enquete_campo = document.querySelector('.enquete_campo');
			let enquete_input = document.querySelector('.enquete_input');
			
			//console.log( 'recebe_enquete_input', recebe_enquete_input ); 
			
			const recebe_enquete_input_array = recebe_enquete_input.split(";");
			
			//console.log( 'recebe_enquete_input_array', recebe_enquete_input_array ); 
			
			for( var item in recebe_enquete_input_array ) {
	
				//console.log( 'recebe_enquete_input_array[item]', recebe_enquete_input_array[item] );
				
				const quest_array = recebe_enquete_input_array[item].split("=");
				
				//console.log( 'quest_array', quest_array );
				...
				if( 
					...
					const forma_array = quest_array[0].split("_");
					
					//console.log( 'forma_array', forma_array );
					
					counterQuestao = forma_array[1];
			...
			function getCampo( recebe_enquete_input, questao, campo ){
				...
				for( var item in recebe_enquete_input_array ) {
					...
					if( 
						...
						if( 
							forma_array[2] == campo
							&& forma_array[1] == questao 
						){
							
							//console.log( 'quest_array[1]', quest_array[1] );
							
							return quest_array[1];
			...
			for( let i = 1; i <= counterQuestao; i++ ){ //MONTA O FORMULÁRIO QUE VEM DO BANCO
				
				let obrigatorio = '';
				
				if( getCampo( recebe_enquete_input, i, 'obrigatorio' ) ){
				...
				if( 
					getCampo( recebe_enquete_input, i, 'tipo' ) 
					&& ( 
						getCampo( recebe_enquete_input, i, 'tipo' ) == 'titulo'
						|| getCampo( recebe_enquete_input, i, 'tipo' ) == 'subtitulo'
					)
				){
					
					enquete_campo.innerHTML += ''+
					'<div class="linha questao_'+ i +'">'+
						'<div class="col10"><span class="questao_campo">'+ i +': '+ getCampo( recebe_enquete_input, i, 'campo' ) +'</span></div>'+
						'<div class="col10"><span class="questao_tipo">'+ getCampo( recebe_enquete_input, i, 'tipo' ) +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
								'<div '+
									'class="btn icone" '+
				...
				if( 
					getCampo( recebe_enquete_input, i, 'tipo' ) 
					&& (
						getCampo( recebe_enquete_input, i, 'tipo' ) == 'text'
						|| getCampo( recebe_enquete_input, i, 'tipo' ) == 'email'
						|| getCampo( recebe_enquete_input, i, 'tipo' ) == 'date'
						|| getCampo( recebe_enquete_input, i, 'tipo' ) == 'time'
						|| getCampo( recebe_enquete_input, i, 'tipo' ) == 'datetime-local'
						|| getCampo( recebe_enquete_input, i, 'tipo' ) == 'file'
					)
				){
					...
					'<div class="linha questao_'+ i +'">'+
						'<div class="col10"><span class="questao_campo">'+ i +': '+ getCampo( recebe_enquete_input, i, 'campo' ) +'</span></div>'+
						'<div class="col10"><span class="questao_tipo"><input type="'+ getCampo( recebe_enquete_input, i, 'tipo' ) +'" disabled/></span></div>'+
						'<div class="col20"><span class="questao_comentario">'+ getCampo( recebe_enquete_input, i, 'comentario' ) +'</span></div>'+
						'<div class="col05"><span class="questao_obrigatorio">'+ obrigatorio +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
								'<div '+
				...
				if( 
					getCampo( recebe_enquete_input, i, 'tipo' ) 
					&& getCampo( recebe_enquete_input, i, 'tipo' ) == 'textarea'
				){
				...
				if( 
					getCampo( recebe_enquete_input, i, 'tipo' ) 
					&& getCampo( recebe_enquete_input, i, 'tipo' ) == 'radio_s_n'
				){
					
					enquete_campo.innerHTML += ''+
					'<div class="linha questao_'+ i +'">'+
						'<div class="col10"><span class="campo">'+ i +': '+ getCampo( recebe_enquete_input, i, 'campo' ) +'</span></div>'+
						
						'<span class="questao_radio_s_n">'+
							'<div class="col05">'+
								'<span>'+
									'<input '+
										'type="radio" '+
								...
								'</span>'+
							'</div>'+
							'<div class="col10"><span>Sim</span></div>'+
							...
							'<div class="col05">'+
								...
								'</span>'+
							'</div>'+
							'<div class="col10"><span>Não</span></div>'+
						'</span>'+
						
						'<div class="col20"><span>'+ getCampo( recebe_enquete_input, i, 'comentario' ) +'</span></div>'+
				...
				if( 
					getCampo( recebe_enquete_input, i, 'tipo' ) 
					&& getCampo( recebe_enquete_input, i, 'tipo' ) == 'radio'
				){
					
					enquete_campo.innerHTML += ''+
					'<div class="linha questao_'+ i +'">'+
						'<div class="col10"><span class="questao_campo">'+ i +': '+ getCampo( recebe_enquete_input, i, 'campo' ) +'</span></div>'+
						'<div class="col60 questao_'+ i +' opcoes_radio_aqui"></div>'+
						'<div class="col10"><span class="questao_comentario">'+ getCampo( recebe_enquete_input, i, 'comentario' ) +'</span></div>'+
						'<div class="col05"><span class="questao_obrigatorio">'+ obrigatorio +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
								'<div '+
				...
				if( 
					getCampo( recebe_enquete_input, i, 'tipo' ) 
					&& getCampo( recebe_enquete_input, i, 'tipo' ) == 'checkbox'
				){
					
					enquete_campo.innerHTML += ''+
					'<div class="linha questao_'+ i +'">'+
						'<div class="col10"><span class="questao_campo">'+ i +': '+ getCampo( recebe_enquete_input, i, 'campo' ) +'</span></div>'+
						'<div class="col60 questao_'+ i +' opcoes_checkbox_aqui"></div>'+
						'<div class="col10"><span class="questao_comentario">'+ getCampo( recebe_enquete_input, i, 'comentario' ) +'</span></div>'+
						'<div class="col05"><span class="questao_obrigatorio">'+ obrigatorio +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
				...
				if( 
					getCampo( recebe_enquete_input, i, 'tipo' )
					&& getCampo( recebe_enquete_input, i, 'tipo' ) == 'select'
				){
					...
					'<div class="linha questao_'+ i +'">'+
						...
						'<div class="col10">'+
							'<span>'+
								'<select '+
									'class="contato-form-input questao_'+ i +' select" '+
								'></select>'+
							'</span>'+
						'</div>'+
						'<div class="col15"><span class="questao_comentario">'+ getCampo( recebe_enquete_input, i, 'comentario' ) +'</span></div>'+
						'<div class="col05"><span class="questao_obrigatorio">'+ obrigatorio +'</span></div>'+
						'<div class="col10 acao">'+
							'<span>'+
								'<div '+
				...
				if( 
					getCampo( recebe_enquete_input, i, 'opcao01' ) 
					&& getCampo( recebe_enquete_input, i, 'opcao01' ) != ''
				){

					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'radio' ){
					
						document.querySelector('.questao_'+ i +'.opcoes_radio_aqui').innerHTML += ''+
						'<div class="col05">'+
							'<span>'+
								'<input '+
									'type="radio" '+
							...
							'</span>'+
						'</div>'+
						'<div class="col10"><span class="questao_'+ i +'_opcao01">'+ getCampo( recebe_enquete_input, i, 'opcao01' ) +'</span></div>'+
						'';
						
					}
					
					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'checkbox' ){
					
						document.querySelector('.questao_'+ i +'.opcoes_checkbox_aqui').innerHTML += ''+
						'<div class="col05">'+
							'<span>'+
								'<input '+
									'type="checkbox" '+
					...
					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'select' ){
					
						document.querySelector('.questao_'+ i +'.select').innerHTML += ''+
							'<option class="questao_'+ i +'_opcao01">'+ getCampo( recebe_enquete_input, i, 'opcao01' ) +'</option>'+
						'';
				...
				if( 
					getCampo( recebe_enquete_input, i, 'opcao02' ) 
					&& getCampo( recebe_enquete_input, i, 'opcao02' ) != ''
				){
					...
					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'radio' ){
						...
						'<div class="col05">'+
							...
							'</span>'+
						'</div>'+
						'<div class="col10"><span class="questao_'+ i +'_opcao02">'+ getCampo( recebe_enquete_input, i, 'opcao02' ) +'</span></div>'+
						'';
					...
					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'select' ){
						...
						document.querySelector('.questao_'+ i +'.select').innerHTML += ''+
							'<option class="questao_'+ i +'_opcao02">'+ getCampo( recebe_enquete_input, i, 'opcao02' ) +'</option>'+
						'';
				...
				if( 
					getCampo( recebe_enquete_input, i, 'opcao03' ) 
					&& getCampo( recebe_enquete_input, i, 'opcao03' ) != ''
				){
					...
					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'radio' ){
						...
						'<div class="col05">'+
							...
							'</span>'+
						'</div>'+
						'<div class="col10"><span class="questao_'+ i +'_opcao03">'+ getCampo( recebe_enquete_input, i, 'opcao03' ) +'</span></div>'+
						'';
					...
					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'select' ){
						...
						document.querySelector('.questao_'+ i +'.select').innerHTML += ''+
							'<option class="questao_'+ i +'_opcao03">'+ getCampo( recebe_enquete_input, i, 'opcao03' ) +'</option>'+
						'';
				...
				if( 
					getCampo( recebe_enquete_input, i, 'opcao04' ) 
					&& getCampo( recebe_enquete_input, i, 'opcao04' ) != ''
				){
					...
					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'radio' ){
						...
						'<div class="col05">'+
							...
							'</span>'+
						'</div>'+
						'<div class="col10"><span class="questao_'+ i +'_opcao04">'+ getCampo( recebe_enquete_input, i, 'opcao04' ) +'</span></div>'+
						'';
					...
					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'select' ){
						...
						document.querySelector('.questao_'+ i +'.select').innerHTML += ''+
							'<option class="questao_'+ i +'_opcao04">'+ getCampo( recebe_enquete_input, i, 'opcao04' ) +'</option>'+
						'';
				...
				if( 
					getCampo( recebe_enquete_input, i, 'opcao05' ) 
					&& getCampo( recebe_enquete_input, i, 'opcao05' ) != ''
				){
					...
					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'radio' ){
						...
						'<div class="col05">'+
							...
							'</span>'+
						'</div>'+
						'<div class="col10"><span class="questao_'+ i +'_opcao05">'+ getCampo( recebe_enquete_input, i, 'opcao05' ) +'</span></div>'+
						'';
					...
					if( getCampo( recebe_enquete_input, i, 'tipo' ) == 'select' ){
						...
						document.querySelector('.questao_'+ i +'.select').innerHTML += ''+
							'<option class="questao_'+ i +'_opcao05">'+ getCampo( recebe_enquete_input, i, 'opcao05' ) +'</option>'+
						'';
