							...
							foreach( $menu_admin_array as $menu ){
								...
								if( $menu_sinc['menu_admin_id'] == $menu['id'] ){
									...
									<div class="menu-btn '; if( isset( $_GET['pagina'] ) && $_GET['pagina'] == $menu['pagina'] ){ echo'menu-btn-on'; } echo'">
										...
										<div class="menu-pin"><a href="modulos/menu_admin/controller/favoritar.php?menu_id='. $menu['id'] .'&esta_favoritado=nao">'; require $raiz_admin .'img/pin-vazado.svg'; echo'</a></div>
