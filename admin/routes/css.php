...
foreach( $admin_user_array as $cfg ){
	if( $cfg['tema'] == 'escuro' && $_COOKIE['fronteira_ADMIN_SESSION_usuario'] == $cfg['usuario'] ){ require $raiz_admin .'css/escuro.css'; }
	if( $cfg['tema'] == 'claro' && $_COOKIE['fronteira_ADMIN_SESSION_usuario'] == $cfg['usuario'] ){ require $raiz_admin .'css/claro.css'; }
}

require $raiz_admin .'css/estilo.css'; 
require $raiz_admin .'css/scroll.css'; 
